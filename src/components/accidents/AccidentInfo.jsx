      ...
      <form className="row" action="#">
        ...
        <div className="form-group col-md-4">
          ...
          <select className="browser-default custom-select">
            ...
            <option value="loss">OWN3P Own damage including third party person</option>
            <option value="loss">OWN3V Own damage including third party person</option>
            ...
            <option value="loss">Special Perils (Earthquake, Flood and Lightening)</option>
            <option value="loss">Hit and Run by Third Party Vehicle</option>

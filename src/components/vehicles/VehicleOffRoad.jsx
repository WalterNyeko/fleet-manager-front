            ...
            <div className="page-title-box">
              <div className="row align-items-center">
                <div className="col-sm-6">
                  <h4 className="page-title">Add Vehicle Off Road</h4>
                </div>
                      ...
                      <div className="form-group col-md-6">
                        ...
                        <div>
                          <input
                            ...
                            className="form-control"
                            required
                            placeholder="Date Vehicle Recieved at Workshop"
                          />
                        </div>
                      </div>
                      <div className="form-group col-md-6">
                        ...
                        <div>
                          <input
                            ...
                            className="form-control"
                            required
                            placeholder="Grounded Period (Days)"
                          />
                        </div>
                      </div>
                      <div className="form-group col-md-6">
                        <label>Remark/Comment/Status</label>
                        <div>
                          <input
                            data-parsley-type="alphanum"
                            type="text"
                            className="form-control"
                            required
                            placeholder="Remark/Comment/Status"
                          />
                        </div>
                      </div>
                      <div className="form-group col-md-6">
                      ...
                      <div className="form-group col-md-6">
                        ...
                        <div>
                          <input
                            ...
                            className="form-control"
                            required
                            placeholder="Grounded Vehicle Status"
                          />
                        </div>
                      </div>
                      <div className="form-group col-md-6">

    ...
    <div className="row">
      <form className="row" action="#">
        ...
        <div className="form-group col-md-4">
          ...
          <select className="browser-default custom-select">
            <option selected></option>
            <option value="reason">ACCIDENT REPAIRS - BELOW EXCESS</option>
            <option value="reason">ACCIDENT REPAIRS - BROKEN APPROVED</option>
        ...
        <div className="form-group col-md-4">
          ...
          <select className="browser-default custom-select">
            ...
            <option value="job">Work Completed awaiting photo upload</option>
        ...
        <div className="form-group col-md-4">
          ...
          <select className="browser-default custom-select">
            ...
            <option value="paperwork">Verbal Confirmation no paperwork</option>

  ...
  return (
    <div className="row">
      <form className="row" action="#">
        ...
        <div className="form-group col-md-4">
          <label>Contract RV Payment Date</label>{" "}
          <input type="text" className="form-control" required placeholder="" />
        </div>
        <div className="form-group col-md-4">
        ...
        <div className="form-group col-md-4">
          ...
          <select className="browser-default custom-select">
            ...
            <option value="contract">BODY REPAIRS INCLUDED (MAINTENANCE)</option>
            <option value="contract">COLLECTION & DELIVERY</option>
            <option value="contract">COMMERCIAL VEHICLE CONTRACTS RETURN AGREEMENT</option>
            <option value="contract">COURTESY VEHICLE PROVIDED FOR SERVICE</option>
            ...
            <option value="contract">FULL COVER ON TYRES (INCLUDING PUNCTURES)</option>
            <option value="contract">FULL MAINTENANCE COVER</option>
            <option value="contract">FULL LEASE INCLUDING TYRES, BETTERY & ACCIDENT REPAIR</option>
            <option value="contract">FULL MAINTENANCE NO REPLACEMENT VEHICLE</option>
            ...
            <option value="contract">NO COLLECTION & DELIVERY FOR SERVICE OR REPAIRS</option>
            ...
            <option value="contract">NO REPLACEMENT VEHICLE AVAILABLE</option>
            <option value="contract">NO REPLACEMENT VEHICLE AVAILABLE SUPPLIED CHARGE $75</option>
            ...
            <option value="contract">OUT OF HOURS SERVICING NOT INCLUDED</option>
            ...
            <option value="contract">REPLACEMENT VEHICLE AFTER 12 HOURS</option>
            <option value="contract">REPLACEMENT VEHICLE AFTER 24 HOURS</option>
            <option value="contract">REPLACEMENT VEHICLE AFTER 48 HOURS</option>
            ...
            <option value="contract">SEE TRANSOLVER MAINTENACE COVER</option>
            <option value="contract">SERVICE AGREEMENT</option>
            <option value="contract">SERVICE AND REPAIR WORK ON CRANE (CHARGEABLE)</option>
            <option value="contract">SERVICE AND REPAIR WORK ON CRANE FULL MAINTENANCE</option>
            <option value="contract">SERVICE ONLY</option>
            <option value="contract">TAIL LIFT FULL MAINTENANCE COVER</option>
            <option value="contract">TYRES REFER TO LEASE COMPANY FOR ORDER</option>
          </select>
        </div>
        <div className="form-group col-md-4">

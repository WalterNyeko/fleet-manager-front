            ...
            <div className='row'>
              <div className='form-group col-md-12'>
                ...
                <input
                  ...
                  required
                  placeholder=''
                  name='tyresAndBatteries'
                  value={tyresAndBatteries}
              ...
              <div className='form-group col-md-12'>
                ...
                <input
                  ...
                  required
                  placeholder=''
                  name='restorationWorksPosition'
                  value={restorationWorksPosition}
                  onChange={handleInputChange}
                />
              </div>
              <div className='form-group col-md-12'>
              ...
              <div className='form-group col-md-12'>
                ...
                <input
                  ...
                  required
                  placeholder=''
                  name='totalMaintenanceProvision'
                  value={totalMaintenanceProvision}
                  onChange={handleInputChange}
                />
              </div>
            </div>
            ...
            <div className='row'>
              ...
              <div className='form-group col-md-6'>
                ...
                <select
                  ...
                  name='electronicallyInvoiced'
                  value={electronicallyInvoiced}
                  onChange={handleInputChange}
                >
                  <option selected />
              ...
              <div className='form-group col-md-6'>
                ...
                <input
                  ...
                  required
                  placeholder=''
                  name='contractAnnualDistance'
                  value={contractAnnualDistance}
                  onChange={handleInputChange}
                />
              </div>
              ...
              <div className='form-group col-md-6'>
                ...
                <input
                  ...
                  required
                  placeholder=''
                  name='fuelProvisionPerMonth'
                  value={fuelProvisionPerMonth}
                  onChange={handleInputChange}
                />
              </div>
              ...
              <div className='form-group col-md-6'>
                ...
                <select
                  className='browser-default custom-select'
                  name='salesPreparationDate'
                  value={salesPreparationDate}
                  onChange={handleInputChange}
                >
                  <option selected />
              ...
              <div className='form-group col-md-6'>
                ...
                <input
                  ...
                  required
                  placeholder=''
                  name='leaseContactNumber'
                  value={leaseContactNumber}
                  onChange={handleInputChange}
                />
              </div>
              <div className='form-group col-md-6'>
          ...
          <div className='card-body custom-card'>
            <div className='row'>
              ...
              <div className='form-group col-md-6'>
                ...
                <select
                  className='browser-default custom-select'
                  name='contractOptionCode'
                  value={contractOptionCode}
                  onChange={handleInputChange}
                >
                  <option selected />
